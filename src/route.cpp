...
//    if (WayPoints.empty()) {
//        QMessageBox::warning(nullptr, "Ошибка", "Нет маршрута для сохранения.");
//        return;
//    }

//    QString fileName = QFileDialog::getSaveFileName(nullptr, "Сохранить маршрут", "", "XML файлы (*.xml)");
//    if (fileName.isEmpty()) {
//        return;
//    }
...
//    file.close();
//    QMessageBox::information(nullptr, "Сохранение завершено", "Маршрут успешно сохранен в файл.");
//}
